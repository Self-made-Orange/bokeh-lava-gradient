...
tool/
  update_readme.dart         # regenerates the preset table from active presets
docs/                        # built web demo (served by GitHub Pages)
```

> The preset table above is auto-generated from the **uncommented** presets by
> `tool/update_readme.dart`, and kept in sync on push by
> `.github/workflows/sync-readme.yml`. Run it locally with
