...
**https://keepyaoung.github.io/bokeh-lava-gradient/bg-only/**  ·  _(this branch — 3 presets)_
...
All 7 presets (✅ = active in this branch's demo; 💤 = commented out in code):
...
| `light2` | ✅ | `#FAFAFA` | `#A8D795` `#DB7842` `#ECF2E5` `#FFF4D8` | 0.80 |
